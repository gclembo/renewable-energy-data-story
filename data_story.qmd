...
yearly_co2 |> 
  ...
  labs(
    ...
    caption = str_wrap("Data source: Lan, X. (n.d.). Trends in CO2 - NOAA Global Monitoring Laboratory. GML. https://gml.noaa.gov/ccgg/trends/data.html", 70)
  ) +
  theme_bw() +
  theme(
...
weather_disasters |> 
  ...
  labs(
    ...
    caption = str_wrap("Data source: NOAA National Centers for Environmental Information (NCEI). (2024). Billion-dollar weather and climate disasters. Billion-Dollar Weather and Climate Disasters | National Centers for Environmental Information (NCEI). https://www.ncei.noaa.gov/access/billions/time-series/US/cost", 70)
  ) +
  theme_bw() +
  theme(
    panel.border = element_blank(),
...
recent_industry_emissions |> 
  ...
  labs(
    ...
    caption = str_wrap("Data source: Environmental Protection Agency. (2023, August 18). Greenhouse Gas Inventory Data Explorer. EPA. https://cfpub.epa.gov/ghgdata/inventoryexplorer ", 70)
  ) +
...
generation_US_wanted |> 
  ...
  labs(
    ...
    caption = str_wrap("Data source: U.S. Energy Information Administration. (n.d.). Electricity Data Browser. Electricity Data Browser - U.S. Energy Information Administration (EIA). https://www.eia.gov/electricity/data/browser/")
  ) +
  scale_x_continuous(
    limits = c(2000, 2027), 
...
co2_by_fuel |> 
  ...
  labs(
    ...
    y = "Energy Source",
    caption = str_wrap("Data source: Nicholson, S., & Heath, G. (2023, December 12). Life cycle emissions factors for Electricity Generation Technologies. Life Cycle Emissions Factors for Electricity Generation Technologies | NREL Data Catalog. https://data.nrel.gov/submissions/171")
  ) + 
  theme_minimal()
...
mortality_by_fuel |> 
  ...
  labs(
    ...
    y = "Energy Source",
    caption = str_wrap("Data source: Tiseo, I. (2023, September 12). Global deaths per energy source. Statista. https://www.statista.com/statistics/494425/death-rate-worldwide-by-energy-source/ ")
  ) + 
  theme_minimal()
